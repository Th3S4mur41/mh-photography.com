...
export const ui = {
	de: {
		...
		'weddings.p1':
			'Ich weiß, dass deine Hochzeit ein einzigartiger und unvergesslicher Tag ist, und ich möchte jeden Moment, jede Emotion und jedes Detail mit meiner Kamera einfangen. Ich bin Manuel und hatte das Privileg, viele verschiedene Hochzeiten in ganz Europa zu verewigen.',
		'weddings.p2':
			'Lass mich dir etwas über meine Arbeitsweise erzählen, damit du mich besser kennenlernen kannst. Ich passe mich deinem Stil und deinen Vorlieben an. Es ist dein Tag, und wir möchten die Liebe, die Magie und die Essenz in jedem Bild festhalten. Ich werde diskret auf die wichtigsten und spontansten Momente während deiner Feierlichkeit achten.',
		'weddings.p3':
		...
		'weddings.p4':
			'Ich weiß, wie es sich anfühlt, vor der Kamera zu stehen, daher bemühe ich mich, eine persönliche Verbindung zu dir und deinen Lieben aufzubauen. Mein Ziel ist es, dass du dich entspannst und deinen Tag in vollen Zügen genießt, während ich dafür sorge, die schönsten Erinnerungen zu schaffen.',
		'weddings.p5':
			'Indem du mich als deinen Fotografen wählst, entscheidest du dich für jemanden, der engagiert ist und ein geschultes Auge für Details hat. Mein Ziel ist es, deine Erwartungen zu übertreffen und dir einen visuellen Schatz zu überreichen, der für immer bestehen bleibt.',
		'weddings.p6':
			'Ich freue mich darauf, dich kennenzulernen und dir dabei zu helfen, diesen Teil deiner Liebesgeschichte zu bewahren. Ich lade dich ein, einen Blick auf mein Portfolio zu werfen und meinen Stil zu entdecken.',
	...
	en: {
		'meta.keywords':
			'manuel hamel, manuel hamel photography, photography, photographer, professional photographer, photographer in Barcelona, Barcelona, wedding photographer, wedding photographer in Barcelona, professional wedding photographer, wedding photography, wedding photography packages, luxury wedding photography, high end wedding photography, people photographer, people photographer in Barcelona, people photography, family photographer, family photographer in Barcelona, family photography, kids photographer, kids photography, baby photography, newborn photography, events photographer, events photographer, business photographer, studio photography, artistic photography, lifestyle photography, videography, portraits, publications, ',
		'nav.menu': 'Menu',
		'nav.home': 'Home',
		'nav.about': 'About me',
		'nav.photos': 'Photos',
	...
	es: {
		...
		'weddings.p1':
			'Sé que tu boda es un día único e irrepetible, y quiero capturar cada momento, cada emoción y cada detalle con mi cámara. Soy Manuel, y he tenido la dicha de inmortalizar muchas bodas al rededor de Europa.',
		'weddings.p2':
			'Te cuento sobre mi forma de trabajar para que me conozcas mejor. Me adapto a tu estilo y a tus preferencias. Es tu día y queremos capturar el amor, la magia y toda su esencia. Estaré de forma muy sutil atento a los momentos más importantes y a esos más espontáneos durante tu celebración.',
		'weddings.p3':
			'En las fotos que recibirás, verás desde las miradas de amor, los besos y abrazos cariñosos, hasta las risas más sinceras. Te aseguro que te acompañaré en esos instantes y además los capturaré con el estilo artístico y auténtico que caracterizan mis tomas. Mi trabajo no se limita a disparar miles de fotos, sino a crear una experiencia agradable y divertida para ti y tus invitados ese día y ayudarte a contar esa historia de por vida.',
		'weddings.p4':
			'Sé lo que se siente estar frente a la cámara, por eso me esfuerzo por construir una conexión personal contigo y con los tuyos. Mi meta es que te relajes y disfrutes al máximo de tu día, mientras yo me ocupo de ocasionar los recuerdos más bonitos.',
		'weddings.p5':
			'Al elegirme como tu fotógrafo, eliges a alguien comprometido y con un ojo entrenado para los detalles. Mi objetivo es superar tus expectativas y entregarte un tesoro visual que dure para siempre.',
		'weddings.p6':
			'Estoy emocionado de conocerte y ayudarte a resguardar esta parte de tu historia de amor. Te invito a ver mi portafolio y descubrir mi estilo.',
